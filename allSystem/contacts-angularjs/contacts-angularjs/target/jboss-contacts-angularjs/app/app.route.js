    ...
    function config($httpProvider, $routeProvider) {
        ...
        $routeProvider.
            ...
            when('/home', {
                ...
                templateUrl: 'templates/hotel/hotelList.html',
                controller: 'AppControllerHotel'

            }).when('/addHotel', {
                templateUrl: 'templates/hotel/hotelForm.html',
                controller: 'HotelController'
            }).when('/editHotel/:contactId', {
                templateUrl: 'templates/hotel/hotelForm.html',
                controller: 'HotelController'

            }).when('/booking', {
                templateUrl: 'templates/booking/bookingList.html',
                controller: 'AppControllerBooking'

            }).when('/addBooking', {
                templateUrl: 'templates/booking/bookingForm.html',
                controller: 'BookingController'
            }).when('/editBooking/:contactId', {
                templateUrl: 'templates/booking/bookingForm.html',
                controller: 'BookingController'
