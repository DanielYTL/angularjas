...
public class ContactRegistrationTest {
    ...
    public void testRegister() throws Exception {
        Contact contact = createContactInstance("Jack", "Doe", "jack@mailinator.com", "(012) 5555-1234");
    ...
    public void testInvalidRegister() throws Exception {
        Contact contact = createContactInstance("lal123", "", "qwe123ssdf", "(567)333-222");
        Response response = contactRESTService.createContact(contact);
    ...
    @Test
    @InSequence(3)
    public void testIncompleteRegister() throws Exception {
    ...
    public void testDuplicateEmail() throws Exception {
        ...
        Contact contact = createContactInstance("Jane", "Doe", "jane@mailinator.com", "(012) 5556-1234");
        contactRESTService.createContact(contact);

        // Register a different user with the same email
        Contact anotherContact = createContactInstance("John", "Doe", "jane@mailinator.com", "(013) 3555-1234");
    ...
    public void testRetrieveCustomers() throws Exception {
        ...
        log.info(" All customers retrieve failed with return code " + response.getStatus());
    }
    ...
    public void testDeleteRegister() throws Exception {
    	Contact contact = createContactInstance("Hola", "Adios", "lala@hotmail.com", "(015) 9988-5555");
     ...
     */
    private Contact createContactInstance(String firstName, String lastName, String email, String phone) {
