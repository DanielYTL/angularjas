    ...
    public Response deleteContact(@PathParam("id") Long id) {
        ...
        try {
            ...
            if (contact != null) {
                ...
                Response response = Response.status(Response.Status.FORBIDDEN).entity("Customer records cannot be deleted!").build();
                throw new WebApplicationException(response);
            } else {
                log.info("ContactRESTService - deleteContact - No contact with matching ID was found.");
                throw new WebApplicationException(Response.Status.NOT_FOUND);
            }
