...
public class TaxiValidator {
    ...
    void validateTaxi(Taxi taxi) throws ConstraintViolationException, ValidationException {
        ...
        // Check the uniqueness of the registration address
    ...
    /**
     * <p>Checks if a taxi with the same registration address is already registered. This is the only way to easily capture the
