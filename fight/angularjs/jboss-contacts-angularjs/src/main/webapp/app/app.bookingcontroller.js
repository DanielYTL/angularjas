...
(function() {
    ...
    angular
        .module('app')
        .controller('AppBookingController', AppBookingController);

    AppBookingController.$inject = ['$scope', '$filter', 'Booking', 'messageBag'];

    function AppBookingController($scope, $filter, Booking, messageBag) {
        ...
        var getHeadings = function(bookings) {
            ...
            for(var i = 0; i<bookings.length; i++) {
                ...
                var startsWithLetter = bookings[i].bookingDate;
