    ...
    function config($httpProvider, $routeProvider) {
        ...
        $routeProvider.
            ...
            when('/home', {
				...
				//If URL fragment is '/flight', then load the contactForm.html template, with ContactController
            }).when('/flight', {
                ...
                controller: 'AppBookingController'
                ...
                //If URL fragment is '/addflight', then load the flightForm.htm. template, with ContactController
